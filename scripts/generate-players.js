...
const POS_MAP = {
  ...
  basketball: { 'Point Guard':'Base / Escolta','PG':'Base / Escolta','Shooting Guard':'Base / Escolta','SG':'Base / Escolta','Small Forward':'Alero / Ala-Pívot','SF':'Alero / Ala-Pívot','Power Forward':'Alero / Ala-Pívot','PF':'Alero / Ala-Pívot','Center':'Pívot','C':'Pívot','Guard':'Base / Escolta','G':'Base / Escolta','Forward':'Alero / Ala-Pívot','F':'Alero / Ala-Pívot' },
  football:   { 'Quarterback':'QB','QB':'QB','Running Back':'RB','RB':'RB','Fullback':'RB','FB':'RB','Wide Receiver':'WR','WR':'WR','Tight End':'TE','TE':'TE','Offensive Tackle':'OL','OT':'OL','Offensive Guard':'OL','OG':'OL','G':'OL','T':'OL','Center':'OL','C':'OL','Defensive Tackle':'DL','DT':'DL','Defensive End':'DL','DE':'DL','NT':'DL','Linebacker':'LB','LB':'LB','ILB':'LB','OLB':'LB','MLB':'LB','Cornerback':'DB','CB':'DB','Safety':'DB','S':'DB','SS':'DB','FS':'DB','DB':'DB','Kicker':'K/P','K':'K/P','Punter':'K/P','P':'K/P','Place Kicker':'K/P','PK':'K/P','Long Snapper':'K/P','LS':'K/P' },
